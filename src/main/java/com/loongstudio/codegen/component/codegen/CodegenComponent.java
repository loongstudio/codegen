package com.loongstudio.codegen.component.codegen;

import com.baomidou.mybatisplus.generator.AutoGenerator;
import com.baomidou.mybatisplus.generator.config.*;
import com.baomidou.mybatisplus.generator.config.rules.NamingStrategy;
import com.baomidou.mybatisplus.generator.engine.VelocityTemplateEngine;
import com.loongstudio.codegen.entity.SqliteBaseEntity;
...
//                .superClass(SqliteBaseEntity.class)
    ...
    private PackageConfig packageConfig(String parent, String moduleName) {
        ...
        return builder
                .other(StringUtils.joinWith(CommonConstant.SLASH, VUE_MODULE_NAME))
                .build();
    }
